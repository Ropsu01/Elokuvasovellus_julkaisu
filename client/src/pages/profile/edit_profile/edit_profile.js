    ...
    const handleDeleteUser = async () => {
        try {
            ...
            if (password !== null) {
                ...
                if (confirmed) {
                    const response = await axios.delete(`/user/delete/${username}`, {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
                        data: {
    ...
    return (
        <div className="edit-profile">
            ...
            <div className="current-profile-picture">
                <img src={`/avatars/${selectedAvatar}`} alt="Current Profile" className="current-avatar" />
