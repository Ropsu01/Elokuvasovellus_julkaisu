...
function LeaderboardsPage() {
    ...
    useEffect(() => {
        axios.get('/review/top-reviewers') // Replace with your actual API endpoint
            .then(response => {
    ...
    useEffect(() => {
        axios.get('/favorites/top-favorites') // Adjust the endpoint as needed
            .then(response => {
